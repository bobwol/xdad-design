(function(win){
	...
	tEditor.css="common_js/bootstrap/bootstrap.min.css,"+web_url+"css/bootstrap.min.patch.css,"+web_url+"css/typo.css,"+web_url+"css/typo.patch.css,"+web_url+"css/style.css,common_js/resizable/resizable.css";
	tEditor.simple_config={
				...
				theme_advanced_buttons1 : "newdocument,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,formatselect,|,bullist,numlist,|,outdent,indent,blockquote,|,undo,redo,|,link,unlink,forecolor,|",
