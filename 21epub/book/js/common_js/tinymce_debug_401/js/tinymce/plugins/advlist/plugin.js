...
tinymce.PluginManager.add('advlist', function(editor) {
	...
	olMenuItems = buildMenuItems('OL', editor.getParam(
		...
		"default,number,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman"
	));

	ulMenuItems = buildMenuItems('UL', editor.getParam("advlist_bullet_styles", "default,dash,disc"));
