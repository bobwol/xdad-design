	...
	return function(ed) {
		...
		function defaultFormats() {
			register({
				...
				textindent:{selector:'p',attributes:{'class':'p-s02'}},
				...
				removeformat: [
					{selector: 'b,strong,em,i,font,u,strike,div,h4,h5', remove: 'all', split: true, expand: false, block_expand: true, deep: true},
...
define("tinymce/ui/FormatControls", [
	...
	EditorManager.on('AddEditor', function(e) {
		...
		Factory.add('fontsizeselect', function(settings) {
			var items = [], defaultFontsizeFormats = '8pt 10pt 12pt 14pt 18pt 24pt 36pt 48pt 64pt';
