(function(interaction){
	...
	interaction.view.ShowHide = interaction.view.Base.extend({
		renderinfo:function(){
			...
			if(this.model.get('iCommon'))  this.infoel.append(interaction.template.info.commonxy(this.model.toJSON()));
		...
		updateinfo:function(){
			this.infoel.find('.Pos').replaceWith(interaction.template.info.commonxy(this.model.toJSON()));
