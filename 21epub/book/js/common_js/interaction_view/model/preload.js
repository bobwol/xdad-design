define(['interaction_view/model/base','text!interaction_view/template/preload.js'],function(){
	var PreloadTemplate=require('text!interaction_view/template/preload.js');
...
interaction_view.collection.Preload=interaction_view.collection.Base.extend({
	preloadcheck:function(file,loadstatus){
		...
		interaction_view.setPreloadStatus();
