...
interaction_view.model.RichText=interaction_view.model.Base.extend({
	defaults:{
	...
	setview:function(type){
		this.iview=new interaction_view.view.RichText({model:this});
	},
	setsyncmodel:function(){
	}
})
interaction_view.view.RichText = interaction_view.view.Base.extend({
	events: {
