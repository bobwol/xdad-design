...
interaction_view.model.Map=interaction_view.model.Base.extend({
	defaults:{
	...
	setview:function(type){
		this.iview=new interaction_view.view.Map({model:this});
	},
	setsyncmodel:function(){
	}
})
interaction_view.view.Map = interaction_view.view.Base.extend({
	events: {
