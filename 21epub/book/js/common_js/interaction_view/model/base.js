define(['jquery','backbone','greensock/TweenMax','videojs','buzz','text!interaction_view/template/animateitem_view.js','text!interaction_view/template/message.js'],function(){
	var AnimateElementTemplate=require('text!interaction_view/template/animateitem_view.js');
