...
c.apply(this)
},onDraggedToStage:function(){},_onRender:function(){if(this._intervalID){clearInterval(this._intervalID)
...
W.Classes.newClass({name:"wysiwyg.viewer.managers.WThemeManager",Class:{Extends:"mobile.core.managers.ThemeManager",_getThemeSchemaTypeName:function(){return"WFlatTheme"
},getProperty:function(a,d,b){var c=this.parent(a,d,b);
switch(this.getPropertyType(a)){case"webThemeUrl":return W.Config.getServiceTopologyProperty("staticThemeUrlWeb")+"/"+c+"/";
break
}return c
}}});
...
W.Classes.newClass({name:"wysiwyg.viewer.managers.WViewManager",Class:{Binds:["_fireScreenResizeEvent","_onSiteReady","_onPageNavigation"],Extends:"mobile.core.managers.ViewManagerBase",Static:{SCREEN_RESIZE_EVENT:"ScreenResize"},initialize:function(){this.parent();
...
},_registerMoreCommands:function(a){},_setDataObjectFromHash:function(b,a,c){this.parent(b,a,c);
...
W.Classes.newClass({name:"wysiwyg.viewer.managers.HtmlScriptsLoader",Class:{Extends:"mobile.core.managers.HtmlScriptsLoader",_nonIndexedScriptFiles:["core-data-types.js"],_scriptFiles:["core-data-types.js","core-components.js","web-viewer-components.js","javascript/wysiwyg/viewer/managers/deployment/Deploy.js"]}});
W.Managers.list.combine([{Class:"wysiwyg.viewer.managers.LayoutManager",target:"Layout"},{Class:"wysiwyg.viewer.managers.WCookiesManager",target:"CookiesManager"}]);
W.Managers.override([{Class:"wysiwyg.viewer.managers.WThemeManager",target:"Theme"},{Class:"wysiwyg.viewer.managers.WViewManager",target:"Viewer"},{Class:"wysiwyg.viewer.managers.HtmlScriptsLoader",target:"HtmlScriptsLoader"}]);