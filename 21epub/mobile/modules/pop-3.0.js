	...
	$(function(){
		...
		$.pop.prototype = {
			...
			_render:function(){
				...
				this.$pop.appendTo($('body'));
				this.$foto = this.$pop.find('.slideshow-inner');
				this.$dl = this.$pop.find('dl');
				this.$ul = this.$pop.find('.slideshow-indicators');
				this.$close = this.$pop.find('.close').find('a');
				this.$overlay = this.$pop.find('.overlay');
				this.$prev = this.$pop.find('.left');
				this.$next = this.$pop.find('.right');
			...
			foto_show:function (temp){
				...
				$(self.$foto_imgs[self.index]).parents('div.item').fadeOut();
					$(self.$foto_imgs[temp]).parents('div.item').fadeIn();
