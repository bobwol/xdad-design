;(function (window, $, undefined) {
    "use strict";
    $.pageMap = function infscr(element,options) {
    ...
    $.pageMap.prototype = {
    	_create:function(options){
			var opts = $.extend(true, {}, $.pageMap.defaults, options);
			this.options = opts;
        ...
        _render:function (){
			...
			var html = [];
			html.push('<div class="location-hd"><a href="javascript:void(0)" class="popup-tip" title="切换位置">上海<b>▼</b></a></div>')
        ...
        switch (thisCall) {
            ...
            case 'object':
                ...
                if (instance) {
                    ...
                    instance = new $.pageMap(this,options);
