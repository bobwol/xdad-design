$(document).ready(function() {
	...
	$('.ui-layout-left').load('modules/nav.html', (function() {
		...
		$('.cat-management nav li.menu-material').addClass('active unfold').children('ul').children('li:nth-child(3)').children('a').addClass('active');
...
function setPreview() {
	...
	// TAB
	$('.edit-tab .action-preview, tr.tab .action a[href="#preview"], .lib-mod li.tab .action a[href="#preview"], .component.tab a[href="#preview"], .component.tab button[data-target="#preview"]').click(function() {
		$('#preview .modal-body').empty().css({"background": "#fff"});
		$('#preview').modal();
	...
	// SLIDE
	$('.edit-gallery .ui-layout-center-hd button[data-target="#preview"], tr.gallery .action a[href="#preview"], tr.slide .action a[href="#preview"], .mod-ft .action-preview, .lib-mod li.slide .action a[href="#preview"], .component.slide a[href="#preview"], .component.slide button[data-target="#preview"]').click(function() {
	...
	// MATERIAL
	$('.setting-body a[href="#preview"], #sA .action a[href="#preview"], .ui-layout-right .action button[data-target="#preview"], .material-management table.list tr .action a[href="#preview"], .gallery-list .action a[href="#preview"], .component.image a[href="#preview"], .component.image button[data-target="#preview"]').click(function() {
		$('#preview .modal-body').empty().css({"background": "#222"});
		$('#preview').modal();
		$('#preview .modal-body').append('<div class="loading"></div>');
	...
	// FIXED-DOC
	$('.edit-fixed-doc .topbar button[data-target="#preview"]').click(function() {
		$('#preview .modal-body').empty().css({"background": "#e3e3e3"});
		$('#preview').modal();
		$('#preview .modal-body').load('modules/preview.html > .fixed-doc', (function() {
			setNanoscrollbar();
		}));
	});
	// FLUID-DOC
	$('.edit-fluid-doc .topbar button[data-target="#preview"]').click(function() {
		$('#preview .modal-body').empty().css({"background": "#e3e3e3"});
		$('#preview').modal();
		$('#preview .modal-body').load('modules/preview.html > .fluid-doc', (function() {
			setNanoscrollbar();
		}));
	});
}
