...
$(function () {
	...
	_JT.prototype = {
		init:function (){
			...
			//setTimeout(function(){slef.sortTitle.call(slef)},0);
			$('.chapter-gap').delegate("li", "click", function(e){
		...
		sortTitle:function(){
			...
			function render(parent){
				...
				for(var i = 0;i<items.length;i++){
					...
					a.html(title);
					model_setChapterNumber(a.parent().parent().parent().attr('id'),title);
